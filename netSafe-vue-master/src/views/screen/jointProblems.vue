          ...
          >
            ...
            <el-table-column property="question" label="问题类别" width="140">
              <template #default="scope">
                <span v-if="scope.row.question == '1'">治安类</span>
                <span v-else-if="scope.row.question == '2'">稳定类</span>
                <span v-else-if="scope.row.question == '3'">交通管理类</span>
                <span v-else-if="scope.row.question == '4'">综合执法类</span>
                <span v-else-if="scope.row.question == '5'">环境保护类</span>
                <span v-else>其他类</span>
              </template>
            </el-table-column>
            <el-table-column property="masterdepartment" label="牵头部门" width="120">
              <template #default="scope">
                <span v-if="scope.row.masterdepartment == '1'">党委政府</span>
                <span v-else-if="scope.row.masterdepartment == '2'">公安</span>
                <span v-else-if="scope.row.masterdepartment == '3'">交警</span>
                <span v-else-if="scope.row.masterdepartment == '4'">综合执法</span>
                <span v-else-if="scope.row.masterdepartment == '5'">城建规划</span>
                <span v-else>其他类</span>
              </template>
            </el-table-column>
